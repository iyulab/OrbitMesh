...
using ServerDispatcher = OrbitMesh.Server.Services.IJobDispatcher;
using WorkflowDispatcher = OrbitMesh.Workflows.Execution.IJobDispatcher;

namespace OrbitMesh.Server.Services.Adapters;

/// <summary>
/// Adapter that bridges OrbitMesh.Server.IJobDispatcher to OrbitMesh.Workflows.IJobDispatcher.
